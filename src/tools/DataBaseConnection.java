...
public class DataBaseConnection {
    ...
    static {
        try {
            ...
            //使用绝对路径加载资源文件
            /*
            String classPath = DatabaseConnection.class.getResource("/resource").getPath();
			InputStream is = new FileInputStream(classPath  + "/"+ JDBCPROPERTY);
			*/
            //使用类加载器加载资源
            InputStream is = DataBaseConnection.class.getClassLoader().getResourceAsStream("tools/"+JDBCPROPERTY);
